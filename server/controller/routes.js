...
/*
	If there is a environment variable named JAWSDB_URL, then that will be the value of the variable 'connectionString'.
	If there is not an environment variable named JAWSDB_URL, then the value of the variable 'connectionString' will be the value of the LOCAL_DATABASE environment variable.
*/
let connectionString = process.env.JAWSDB_URL || process.env.LOCAL_DATABASE;
